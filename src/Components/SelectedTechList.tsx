...
const SelectedTechList = ({
  ...
  const handelRemove = (technology: techType) => {
    ...
    toast.warn(`${technology.name} removed from your stack`, {
      ...
      <div className="flex items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          ...
          <div className="flex flex-col">
            <h2 className="text-[12px] font-bold text-[#111928]">
              {technology.name}
            </h2>
        ...
        <button
          className="group flex h-8 w-8 shrink-0 items-center justify-center rounded-lg transition-colors hover:bg-gray-100"
